...
class AddToCartButton extends React.Component {
  ...
  onClick = () => {
    ...
    //sa aiba putin delay intre add to cart si remove from cart
    //si pun un spinner pt loading, cat se face tranzitia intre stari
  ...
  render() {
    ...
    return (
      <button
        //pune clasa active cand e butonul apasat sau sterge clasa atunci cand e scos din cos produsul
